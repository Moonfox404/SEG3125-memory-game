          ...
          <div className="max-w-xl md:max-w-3xl mx-auto my-8 p-4 sm:p-6 bg-base-100 flex flex-col gap-3">
            ...
            <div className="mb-6">
              ...
              <p className="text-base-content leading-relaxed">
                Find and pair all matching objects hidden beneath the cups
                before the board is cleared. Matches remove cups and earn you
                points; mismatches may trigger surprise swaps if enabled.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-base-content leading-relaxed">
                Match and remove all cups. The result screen will show your
                score breakdown and options to <strong>Play Again</strong> or{" "}
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-base-content space-y-2 md:space-y-3">
                ...
                <li>
                  Reduce mistakes for higher scores—accuracy trumps speed.
                </li>
